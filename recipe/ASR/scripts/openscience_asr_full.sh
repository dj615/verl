...
MODEL=/root/workspace/checkpoints/best_openscience_openscience_lora_0_0_ckpt_on_D2
...
for name in "${DATASETS[@]}"; do
  ...
  python -m verl.trainer.main_generation \
    ...
    --data.output_path=$OUT_DIR/best_openscience_openscience_lora_0_0_ckpt_on_D2_${name}.parquet \
    --trainer.nnodes=4 \
